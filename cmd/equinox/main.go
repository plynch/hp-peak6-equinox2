...
func runFixtureDemo() error {
	...
	eval := map[string]string{
		"strong_route_safe_proposition_cluster": "prop-001",
		"near_match_or_event_only_case":         "prop-002",
		"clear_non_match_case":                  "event with single venue only in soccer family",
		"unsupported_shape_case":                "proposition with unsupported_shape=true",
		"ambiguity_case":                        "proposition with ambiguity notes and refusal",
	}
